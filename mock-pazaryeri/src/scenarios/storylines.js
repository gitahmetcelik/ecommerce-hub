...
const STORYLINES = {
  ...
  // Plan Phase 2 gate: payment lands BEFORE the order that it pays for. Channels do this
  ...
  // derived value rather than a column somebody sets (Plan §0, line-level).
  ...
  // back, each claiming the last unit (Plan Phase 4 oversell gate).
  ...
  // An item the hub has never seen. Plan Phase 3: it must land in mapping_candidate and
